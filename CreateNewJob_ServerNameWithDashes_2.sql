...
/****** Object:  StoredProcedure [ivh].[run_executeSSISPackage]    Script Date: 02-03-2018 11:02:35 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [ivh].[run_executeSSISPackage] ( 
...
execute_asynchronously_using_sqlserver_agent:
		...
		compose_command:
					...
					SET @command = CONCAT(@command
											...
											--, ' /SET \Package.Variables[$Package::JSON_SLA];"""', REPLACE(@json_sla_4000, '''', ''''''), '"""'
