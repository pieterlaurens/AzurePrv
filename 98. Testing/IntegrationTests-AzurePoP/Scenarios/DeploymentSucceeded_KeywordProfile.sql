...
DECLARE @projectkey_ll nvarchar(100) = CONCAT(@solution, '_Test_GetKeywordProfile')--'testPipeline'
...
DECLARE @json_config nvarchar(max) =
	$(Q)
	:r "..\Configurations\TestDeployKeywordProfile.json"
	$(Q)
...
print(concat('Get Keyword Profile (run ',@RC,')'))
