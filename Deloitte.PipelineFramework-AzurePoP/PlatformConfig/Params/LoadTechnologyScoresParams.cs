...
{
    public class LoadTechnologyScoresParams
    {
        ...
        public int MinimumNumberOfTechnologiesRequired { get; set; }
        ...
        public LoadTechnologyScoresParams SetSubjectLevelsToCalculate(IEnumerable<Int16> subjectLevels)
        {
        ...
        public LoadTechnologyScoresParams SetIndustryLevelsToCalculate(IEnumerable<Int16> industryLevels)
        {
