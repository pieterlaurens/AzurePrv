...
namespace Deloitte.PipelineFramework.Pipelines
{
    ...
    /// Governance Box.
    /// </summary>
    public class LoadCpcScoresDatamart : Root
    {
        ...
        /// Governance Box.
        /// </summary>
        public LoadCpcScoresDatamart()
        {
            Header = new ConfigHeader
            {
                Creator = "ReportWebsite",
                NameOfApi = PipelineNames.LoadCpcScoresDatamart,
            ...
            ComponentParams = new List<ComponentParam>()
            {
                ...
                new ComponentParam{ PackageName = PackageName.LoadCpcScores,
                    ProjectType = PlatformConfig.Enums.ProjectType.PdfReport,
                    LoadCpcScoresParams = new LoadCpcScoresParams{
