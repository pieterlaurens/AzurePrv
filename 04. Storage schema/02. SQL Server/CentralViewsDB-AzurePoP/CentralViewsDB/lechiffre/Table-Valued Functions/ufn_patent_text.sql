CREATE FUNCTION [lechiffre].[ufn_patent_text]
(
...
BEGIN
	...
	FROM
		[$(pw_v2015b_002)].patstat.family_application_text fat JOIN
		[$(pw_v2015b_002)].patstat.family_metric fm ON fm.inpadoc_family_id=fat.inpadoc_family_id
	where
