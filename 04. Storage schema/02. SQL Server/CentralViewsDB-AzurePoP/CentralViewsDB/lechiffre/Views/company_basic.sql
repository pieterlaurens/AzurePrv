CREATE VIEW [lechiffre].[company_basic] AS
SELECT
	cast(ob.current_bvd_id as nvarchar(50)) as bvd_id
	, company_name
	, postal_code
	, city
...
FROM
	[$(scd_v2016_005)].dbo.orbis_basic ob LEFT OUTER JOIN
	[$(pw_v2015b_002)].company.company_ip_metric cim ON cim.bvd_id=ob.current_bvd_id LEFT OUTER JOIN
	[$(scd_v2016_005_derived_metrics)].dbo.segment s ON s.current_bvd_id=ob.current_bvd_id LEFT OUTER JOIN
	[$(scd_v2016_005_derived_metrics)].dbo.lay_financials layf ON layf.current_bvd_id=ob.current_bvd_id LEFT OUTER JOIN
	[$(scd_v2016_005)].dbo.orbis_stock os ON os.bvd_id=ob.bvd_id
