CREATE VIEW lechiffre.[applicant] AS
SELECT
...
FROM
	[$(pw_v2015b_002)].patstat.person_entry pe LEFT OUTER JOIN
	[$(pw_v2015b_002)].patstat.person_metric pm ON pm.person_id=pe.person_id