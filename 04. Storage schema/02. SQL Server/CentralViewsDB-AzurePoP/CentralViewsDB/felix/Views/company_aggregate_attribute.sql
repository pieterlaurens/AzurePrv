CREATE VIEW felix.[company_aggregate_attribute] AS
SELECT
	ob.bvd_id
...
FROM
	[$(scdr_16_1_server)].[$(scdr_16_1)].dbo.orbis_basic ob LEFT OUTER JOIN
	(SELECT
		*
	FROM
		(select
	...
	from
		[$(scdr_16_1_server)].[$(scdr_16_1)].dbo.deal_acquirer da JOIN
		[$(scdr_16_1_server)].[$(scdr_16_1)].dbo.deal_overview do ON do.deal_id=da.deal_id
	WHERE
