CREATE FUNCTION [scaramanga].[ufn_patent_text]
(
...
BEGIN
	...
	FROM
		[$(pw_v2017a_001)].patstat.family_application_text fat JOIN
		[$(pw_v2017a_001)].patstat.family_metric fm ON fm.inpadoc_family_id=fat.inpadoc_family_id
	where
