CREATE VIEW [scaramanga].[applicant] AS
SELECT
...
FROM
	[$(pw_v2017a_001)].patstat.person_entry pe LEFT OUTER JOIN
	[$(pw_v2017a_001)].patstat.person_metric pm ON pm.person_id=pe.person_id