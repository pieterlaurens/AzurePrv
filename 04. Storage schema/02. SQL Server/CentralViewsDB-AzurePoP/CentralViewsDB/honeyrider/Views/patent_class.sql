CREATE VIEW honeyrider.[patent_class] AS
...
FROM
	[$(pw15b_cpc)].dbo.full_cpc fc LEFT OUTER JOIN
	[$(pw15b_cpc)].dbo.full_cpc_key fk ON fk.all_ipc_id=fc.all_ipc_id LEFT OUTER JOIN
	[$(pw15b_cpc)].dbo.full_cpc_class_size cs ON cs.all_ipc_id=fc.all_ipc_id LEFT OUTER JOIN
	[$(pw15b_cpc)].dbo.full_cpc_aggregate_class_size acs ON acs.all_ipc_id=fc.all_ipc_id LEFT OUTER JOIN
	[$(pw15b_cpc)].dbo.full_cpc_full_label fl ON fl.all_ipc_id=fc.all_ipc_id