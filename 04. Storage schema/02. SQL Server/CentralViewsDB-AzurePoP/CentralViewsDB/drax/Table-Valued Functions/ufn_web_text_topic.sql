CREATE FUNCTION drax.[ufn_web_text_topic]
(
...
BEGIN
	...
	INSERT INTO @es_task_id 
			...
			WHERE
				...
				AND
				s.es_index IN ('test_web_asia.1','web_extract','web.3') -- Arrange here that the used index is aligned with the rest of the data handler (i.e. that the inpadoc_family_id's correspond to the version of pw and pwc)
