CREATE VIEW [volpe].[company_basic] AS
SELECT
...
FROM
	[$(scd_v2017_005)].dbo.orbis_basic ob LEFT OUTER JOIN
	[$(pwc_v2017a_001)].[aggregate].company_ip_metric cim ON cim.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2017_005)].dbo.financials_lay layf ON layf.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2017_005)].dbo.orbis_stock os ON os.bvd_id=ob.bvd_id