CREATE VIEW [spang].[company_basic] AS
SELECT
...
FROM
	[$(scd_v2016_008)].dbo.orbis_basic ob LEFT OUTER JOIN
	[$(pwc_v2016a_003)].[aggregate].company_ip_metric cim ON cim.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_008_derived_metrics)].dbo.segment s ON s.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_008)].dbo.financials_lay layf ON layf.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_008)].dbo.orbis_stock os ON os.bvd_id=ob.bvd_id