CREATE VIEW [vesper].[company_basic] AS
SELECT
...
FROM
	...
	[$(pwc_v2016b_002)].[aggregate].company_ip_metric cim ON cim.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2017_002)].dbo.financials_lay layf ON layf.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2017_002)].dbo.orbis_stock os ON os.bvd_id=ob.bvd_id