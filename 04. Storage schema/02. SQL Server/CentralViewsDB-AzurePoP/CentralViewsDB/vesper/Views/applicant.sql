CREATE VIEW [vesper].[applicant] AS
SELECT
...
FROM
	[$(pw_v2016b_001)].patstat.person_entry pe LEFT OUTER JOIN
	[$(pw_v2016b_001)].patstat.person_metric pm ON pm.person_id=pe.person_id