CREATE VIEW jaws.[company_basic] AS
SELECT
...
FROM
	...
	[$(pw_v2016a_001)].company.company_ip_metric cim ON cim.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_006_derived_metrics)].dbo.segment s ON s.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_006)].dbo.financials_lay layf ON layf.bvd_id=ob.bvd_id LEFT OUTER JOIN
	[$(scd_v2016_006)].dbo.orbis_stock os ON os.bvd_id=ob.bvd_id