...
$TargetLocation = "\\$TargetServer\SsisDlls"
...
$platformDacPacSource = "01. Main\04. Storage schema\02. SQL Server\PlatformDB\bin\Release\PlatformDB.dacpac"
$platformProfile = "01. Main\04. Storage schema\02. SQL Server\PlatformDB\PlatformDB.dev.publish.xml"
...
# & xcopy /Y "01. Main\98. Testing\PipelineTestSuite\PipelineTestSuite\bin\Release\*.exe" "\\$TargetServer\TestSuite"
# & xcopy /Y "01. Main\98. Testing\PipelineTestSuite\PipelineTestSuite\bin\Release\*.dll" "\\$TargetServer\TestSuite"
...
# xcopy /Y "01. Main\Deloitte.PipelineFramework\bin\Release\Deloitte.PipelineFramework.dll" $TargetLocation
# Write-Output "==================== Step 4b: Remote-deploy framework to GAC"
# Invoke-Command -ComputerName $TargetServer -ScriptBlock $sb -ArgumentList "C:\SsisDlls\Deloitte.PipelineFramework.dll"
# 
# # 5. Copy ProjectDb component dacpacs to target server
# Write-Output "==================== Step 5: Copy project datamart binaries to $TargetServer"
# & xcopy /Y /S "01. Main\97. ProjectDatamart\*.dacpac" "\\$TargetServer\ProjectDbDacpacs"
# & xcopy /Y /S "01. Main\97. ProjectDatamart\*.xml" "\\$TargetServer\ProjectDbDacpacs"
# & xcopy /Y /S "01. Main\97. ProjectDatamart\*.dll" "\\$TargetServer\ProjectDbDacpacs"
# 
